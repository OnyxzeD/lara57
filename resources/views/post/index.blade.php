                ...
                $.getJSON("/post-list", function (data) {
                    ...
                    $.each(data.slice(0, jumlah), function (i, row) {
                        $("#row").append("<tr><td>" + (i + 1) + "</td>" +
                            ...
                            "<td>" + row.tech + "</td>" +
                            "<td>" +
                            "<a href='#' class='btn btn-warning btn-sm' data-id='" + row.id + "' data-toggle='modal' data-target='#modal-edit'><i class='glyphicon glyphicon-pencil'></i></a> &nbsp;" +
                            "<a href='#' class='btn btn-danger btn-sm' data-id='" + row.id + "' data-toggle='modal' data-target='#modal-delete'><i class='glyphicon glyphicon-trash'></i></a>" +
                            "</td></tr>");
                    })
                });
            }, 2200);
