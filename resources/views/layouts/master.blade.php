...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet"
          href="{!! asset('AdminLTE-2.4.3/bower_components/font-awesome/css/font-awesome.min.css') !!}">
    <!-- Ionicons -->
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
          href="{!! asset('AdminLTE-2.4.3/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') !!}">
    <!-- Daterange picker -->
    <link rel="stylesheet"
          href="{!! asset('AdminLTE-2.4.3/bower_components/bootstrap-daterangepicker/daterangepicker.css') !!}">
    <!-- bootstrap wysihtml5 - text editor -->
    <link rel="stylesheet"
          href="{!! asset('AdminLTE-2.4.3/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') !!}">
